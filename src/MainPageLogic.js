...
export default {
    ...
    data() {
      return{
        ...
        incrementBlock1:[1000,150,150,150,150,150,500,150,1000,1000,15000,150,150,150,150,150,1000,150,150,150,150,150,150],
        timeBlock1: 0,
        contentBlock2:['d','di','div','div*','div*5','div*5{}','div*5{l}','div*5{lo}','div*5{lor}','div*5{lore}','div*5{lorem}','div*5{lorem2}','div*5{lorem20}'],
        incrementBlock2:[5550, 150, 150,500,150,500,150,150,500,150,150,500,150],
        timeBlock2: 0,
        contentBlock3:['</ about-me >'],
        incrementBlock3: [4400],
        timeBlock3: 0,
        blocks:['','','','','','',''],
